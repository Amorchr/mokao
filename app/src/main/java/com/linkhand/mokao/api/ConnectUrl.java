...
//    public static String REQUESTURL_IMAGE = "http://192.168.1.172/wuye";
     ...
     * 远程服务器
     **/
    public static String REQUESTURL = "http://mokao.177678.top/";
    public static String REQUESTURL_IMAGE = "http://mokao.177678.top/server/";
    /**
     * 本机
     **/
...
//    public static String REQUESTURL = "http://192.168.1.151/server/";
    ...
    public static String LOGIN_SENDPHONECODE = REQUESTURL + "Home/Register/login_send"; // 短信验证码
    public static String LOGIN_REGISTER = REQUESTURL + "Login/Loginzhu"; // 注册
    public static String LOGIN_MIMA = REQUESTURL + "Home/Login/login"; // 密码登陆
...
//    public static String PUBLIC_CANCEL_COLLECT = REQUESTURL + "Publics/Cancel"; //  取消收藏接口
     ...
     * 首页
     */
    public static String PRODUCT_INDEX = REQUESTURL + "Home/Main/index"; //  首页
